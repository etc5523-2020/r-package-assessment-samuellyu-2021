...
## Learn more about **covid19BFI**
  ...
  - The vignette provides further indepth explanation of the what the package provides as well as documentation for all the functions, tools and data.
