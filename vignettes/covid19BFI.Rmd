...
The analysis that can be found in the indvidual sections and their interactive features are detailed below:
  ...
  - **Cases Deaths and Government Intervention**: Contains an interactive comparitive analysis on the each of the following statistics: 
    ...
    - With following interactive elements:
        1. Interactive figure that offers hover and click respones, which are detailed on the page
        2. A drop down menu that allows the user to select the count statistic they whish to compare
        2. A data range input that lets the user adjust the date range of the comparative counts as well as simultaniously adjusting the date range of the table below showing the government intervention in the form of thenumber of measures and policies that were introduced in each month by both countries.
        3. Option three is a tick box option which will manipulate the countries shown in the corresponding table, this allows the user to view tboth countries or the individual country of choice.
